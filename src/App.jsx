...
const localizedContent = {
  "Spanish": {
    ...
    "statResettled": "4,000+ reasentados",
  ...
  "French": {
    ...
    "statResettled": "4 000+ réinstallés",
    ...
    "aboutText2": "Depuis 2001, AIRS a réinstallé 4 000+ réfugiés et immigrants dans le comté de Maricopa. Les programmes d’AIRS offrent logement, nourriture, vêtements, traduction au besoin, cours d’anglais, formation professionnelle, aide à l’emploi, services d’immigration, orientations et autres soutiens.",
    "aboutBadges": [
  ...
  "Arabic": {
    ...
    "statResettled": "تمت إعادة توطين 4,000+ شخصًا",
    ...
    "aboutText2": "منذ عام 2001، أعادت AIRS توطين 4,000+ لاجئًا ومهاجرًا في مقاطعة ماريكوبا. تقدم برامج AIRS السكن، والطعام، والملابس، والترجمة عند الحاجة، وتعليم اللغة الإنجليزية، والتدريب المهني، والمساعدة في التوظيف، وخدمات الهجرة، والإحالات، وأنواعًا أخرى من الدعم.",
    "aboutBadges": [
...
"text": "تدريب على الحافلات والقطار الخفيف مع Phoenix Valley Metro."
  ...
  "Dari": {
      ...
      "statResettled": "4,000+ نفر اسکان مجدد شده‌اند",
      ...
      "aboutText2": "از سال 2001، AIRS تعداد 4,000+ پناهنده و مهاجر را در شهرستان ماریکوپا اسکان مجدد داده است. برنامه‌های AIRS مسکن، غذا، لباس، ترجمه در صورت نیاز، آموزش زبان انگلیسی، آموزش کاری، کمک در کاریابی، خدمات مهاجرتی، معرفی‌ها و حمایت‌های دیگر فراهم می‌کند.",
      "aboutBadges": [
...
"text": "آموزش بس و قطار سبک با Phoenix Valley Metro."
  ...
  "Pashto": {
      ...
      "statResettled": "4,000+ کسان بیا مېشت شوي",
      ...
      "aboutText2": "له 2001 راهیسې AIRS په ماریکوپا کاونټي کې 4,000+ کډوال او مهاجر بیا مېشت کړي دي. د AIRS پروګرامونه کور، خواړه، کالي، د اړتیا پر مهال ژباړه، انګلیسي زده کړه، د کار روزنه، د کار مرسته، د مهاجرت خدمات، راجع کول او نور ملاتړ برابروي.",
      "aboutBadges": [
...
"text": "د Phoenix Valley Metro سره د بس او لایټ ریل روزنه."
  ...
  "Ukrainian": {
      ...
      "statResettled": "4 000+ переселених",
      ...
      "aboutText2": "З 2001 року AIRS допомогла переселити 4,000+ біженців та іммігрантів в окрузі Марікопа. Програми AIRS надають житло, їжу, одяг, переклад за потреби, курси англійської, професійну підготовку, допомогу з працевлаштуванням, імміграційні послуги, направлення та іншу підтримку.",
      "aboutBadges": [
  ...
  "Swahili": {
    ...
    "statResettled": "4,000+ wamepewa makazi mapya",
    ...
    "aboutText2": "Tangu 2001, AIRS imewapa makazi mapya wakimbizi na wahamiaji 4000+ katika Kaunti ya Maricopa. Programu zake hutoa makazi, chakula, mavazi, tafsiri inapohitajika, masomo ya Kiingereza, mafunzo ya kazi, msaada wa ajira, huduma za uhamiaji, rufaa na msaada mwingine.",
    "aboutBadges": [
      "Shirika 501(c)(3)",
      "Ilianzishwa 1989",
  ...
  "Kinyarwanda": {
    ...
    "aboutText2": "Kuva mu 2001, AIRS imaze gutuza impunzi n’abimukira 4,000+ muri Maricopa County. Porogaramu za AIRS zitanga aho kuba, ibiribwa, imyambaro, ubusemuzi igihe bukenewe, amasomo y’Icyongereza, amahugurwa y’akazi, ubufasha mu kazi, serivisi z’abimukira, koherezwa ku zindi nzego n’ubundi bufasha.",
    "aboutBadges": [
      "Umuryango 501(c)(3)",
      "Yashinzwe mu 1989",
...
function Navbar({ language, setLanguage, t }) {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/95 shadow-sm backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-5 py-0.5 lg:px-8">
